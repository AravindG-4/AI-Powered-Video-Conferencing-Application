...
def main():
    # Initialize session state for WebRTC contexts
    if "webrtc_contexts" not in st.session_state:
    ...
    webrtc_contexts: List[WebRtcStreamerContext] = st.session_state["webrtc_contexts"]
    ...
    if self_is_playing and self_ctx not in webrtc_contexts:
        ...
        st.session_state["webrtc_contexts"] = webrtc_contexts
